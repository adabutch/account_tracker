  ...
  <div class="body-cover">
    ...
    <div class="login-wrapper">
      <svg version="1.1" id="city-of-bloomington-logo" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="150px" height="150px" viewBox="0 0 150 150" enable-background="new 0 0 150 150" xml:space="preserve">
        <polygon fill="#36499B" points="31.9991798,21.9479866 22.7739067,12.826499 22.7739067,22.8042793 12.8196859,22.8042793
          21.3657379,32.579998 12.8196859,41.1248817 41.1218987,41.1248817 41.1218987,12.826499 "/>
        <polygon fill="#36499B" points="21.9450626,117.9943542 12.823596,127.2196503 22.8013535,127.2196503 22.8013535,137.1738892
          32.5770493,128.6278229 41.1219177,137.1738892 41.1219177,108.8716202 12.823596,108.8716202 "/>
        <polygon fill="#36499B" points="128.0453339,32.0021477 137.1667938,22.7768517 127.1890411,22.7768517 127.1890411,12.822608
          117.4133453,21.368679 108.8684769,12.822608 108.8684769,41.1248817 137.1667938,41.1248817 "/>
        <polygon fill="#36499B" points="117.9912109,128.0485077 127.2164841,137.1699982 127.2164841,127.1922226 137.1707001,127.1922226
          128.624649,117.4165039 137.1707001,108.8716202 108.8684998,108.8716202 108.8684998,137.1699982 "/>
        <polygon fill="#36499B" points="56.9043694,60.8636856 42.7692757,46.7080574 14.4699984,46.7080574 28.3536053,61.0300636
        ...
        <polygon fill="#36499B" points="93.0956268,89.1328201 107.2307281,103.2884445 135.5299988,103.2884445 121.6463928,88.9664383
        ...
        <polygon fill="#36499B" points="89.1297226,56.9044991 103.2853165,42.7693748 103.2853165,14.4700317 88.9633408,28.3536701
        ...
        <polygon fill="#36499B" points="60.860672,93.0954971 46.7050781,107.230629 46.7050781,135.5299683 61.02705,121.6463318
...
export default {
  ...
  methods: {
    postLogin() {
      ...
      .catch((error) => {
        this.errorMessge = error.response.data.non_field_errors[0];
        console.log(error);
        console.debug(error);
        console.dir(error);
      })
